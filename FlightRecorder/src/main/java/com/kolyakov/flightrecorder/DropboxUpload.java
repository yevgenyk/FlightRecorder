...
public class DropboxUpload extends AsyncTask<Void, Long, Boolean> {
    ...
    protected UploadProgress mUploadProgress;
    Context mContext;
    ...
    public DropboxUpload(Context context, DropboxAPI<?> api,
        ...
        mDialog.setMax(100);
      //mDialog.setMessage(file.getName());
        mDialog.setMessage("" + (total - index) + "/" + total);
    ...
    protected void onPostExecute(Boolean success) {
        ...
        if (mUploadProgress != null) {
            mUploadProgress.OnComplete(success, mErrorMsg);
        }
